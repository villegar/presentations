...
#| echo: true
#| cache: true
response <- httr::GET("http://127.0.0.1:6238/pop_cr_1982")
response
...
```{.r code-line-numbers="|1|2-3|3-4|7-8|"}
...
url <- URLencode("http://127.0.0.1:6238/pop_country?country=United Kingdom&year=1982")
...
```{.r}
URLencode("http://127.0.0.1:6238/pop_country?country=United Kingdom&year=1982")
```
...
#| cache: false
# encode URL / replace spaces, etc.
url <- URLencode("http://127.0.0.1:6238/pop_country?country=United Kingdom&year=2024")
response <- httr::GET(url)
response
...
#| cache: true
# encode URL / replace spaces, etc.
url <- URLencode("http://127.0.0.1:6238/pop_country_change?country=Costa Rica")
response <- httr::GET(url)
response
...
- Cheatsheet: [https://github.com/rstudio/cheatsheets/blob/main/plumber.pdf](https://github.com/rstudio/cheatsheets/blob/main/plumber.pdf)
