...
park_1_reviews_tb <- readr::read_rds("data/park_1_reviews_tb.Rds")
park_1_reviews_tb_with_text <- readr::read_rds("data/park_1_reviews_tb_with_text.Rds")
uol_waterhouse_park <- readr::read_rds("data/uol_waterhouse_park.Rds")
uol_waterhouse_park_page_2 <- readr::read_rds("data/uol_waterhouse_park_page_2.Rds")
uol_waterhouse_park_page_3 <- readr::read_rds("data/uol_waterhouse_park_page_3.Rds")
waterhouse_parks <- readr::read_rds("data/waterhouse_parks.Rds")
gmaps_liverpool <- readr::read_rds("data/gmaps_liverpool.Rds")
...
.center[
```{r, echo = FALSE, results='asis'}
insert_qr("mailto:roberto.villegas-diaz@liverpool.ac.uk?subject=R-thritis - R packages", 
          "roberto.villegas-diaz@liverpool.ac.uk",
          size = 300)
```
]
