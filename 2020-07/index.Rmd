...
4. MetPy Mondays: [[YouTube](https://www.youtube.com/playlist?list=PLQut5OXpV-0ir4IdllSt1iEZKTwFBa7kO)] <br>
Cursos cortos semanales de aplicaciones en Ciencias Atmosféricas.

--

5. R4DS: [[Slack](r4ds.io/join)] <br>
...
- Superficie: 244,106 km<sup>2</sup> $\sim$ 4.7 superficie de Costa Rica 
...
<!-- [villegas.roberto@hotmail.com](mailto:villegas.roberto@hotmail.com) -->

Github: [@villegar](https://github.com/villegar)

Twitter: [@roberthillo](https://github.com/villegar)

<img src="images/linkedin.png" alt="LinkedIn" style="width: 150px" /><br>
<span style="font-size: 12px">LinkedIn</span>
```{r, echo = FALSE, fig.width=3, eval=FALSE}
library(qrcode)
#png("qrplot.png")
qrcode_gen("https://www.linkedin.com/in/roberthillo/")
#dev.off()
```